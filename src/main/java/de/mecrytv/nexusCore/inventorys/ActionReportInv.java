            ...
            DatabaseAPI.<ReportModel>get("reports", caseID).thenAccept(report -> {
                ...
                NexusCore.getInstance().getSkinCacheManager().getProfile(targetUUID, report.getTargetName()).thenAccept(cachedProfile -> {
                    Bukkit.getScheduler().runTask(NexusCore.getInstance(), () -> {
                        Component title = TranslationUtils.sendGUITranslation(finalLang, "gui.actionReport.title");
                        ...
                        targetHead.editMeta(SkullMeta.class, meta ->{
                            ...
                            lore.add(Component.empty());
                            lore.add(TranslationUtils.sendGUITranslation(finalLang, "gui.reports.heads.state", "{state}", report.getState()));
                            lore.add(TranslationUtils.sendGUITranslation(finalLang, "gui.reports.heads.staff", "{staff}", report.getStaffName()));
                        ...
                        unClaimItem.editMeta(meta -> {
                            meta.addItemFlags(ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ADDITIONAL_TOOLTIP);
                            meta.displayName(TranslationUtils.sendGUITranslation(finalLang, "gui.actionReport.unclaim"));
                        });
                        GuiItem unClaimGuiItem = ItemBuilder.from(unClaimItem).asGuiItem();

                        ItemStack historyItem = new ItemStack(Material.BOOK);
                        historyItem.editMeta(meta -> {
                            meta.addItemFlags(ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ADDITIONAL_TOOLTIP);
                            meta.displayName(TranslationUtils.sendGUITranslation(finalLang, "gui.actionReport.history"));
                        });
                        ...
                        punishItem.editMeta(meta -> {
                            meta.addItemFlags(ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ADDITIONAL_TOOLTIP);
                            meta.displayName(TranslationUtils.sendGUITranslation(finalLang, "gui.actionReport.punish"));
                        });
                        ...
                        proofItem.editMeta(meta -> {
                            meta.addItemFlags(ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ADDITIONAL_TOOLTIP);
                            meta.displayName(TranslationUtils.sendGUITranslation(finalLang, "gui.actionReport.proof"));
                        ...
                        teleportItem.editMeta(meta -> {
                            meta.addItemFlags(ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ADDITIONAL_TOOLTIP);
                            meta.displayName(TranslationUtils.sendGUITranslation(finalLang, "gui.actionReport.teleport"));
                        });
                        ...
                        closeItem.editMeta(meta -> {
                            meta.addItemFlags(ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ADDITIONAL_TOOLTIP);
                            meta.displayName(TranslationUtils.sendGUITranslation(finalLang, "gui.actionReport.close"));
                        });
